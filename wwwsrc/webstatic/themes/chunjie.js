(function () {
    ...
    const makeElement = function (align) {
        ...
        div.setAttribute('style', `position: fixed; top: 2vh; height: 96vh; width: 15.7vh; ${align}: 2vh;`)
        let img = document.createElement('img');
        img.setAttribute('class', 'pinMySize');
    ...
    if (window.screen.availHeight > 700) {
        const hengpi = (function () {
            ...
            div.setAttribute('style', `position: fixed; top: 2vh; width: 100vw; height: ${96 / 2152 * 350}vh; left: 0px;`);
