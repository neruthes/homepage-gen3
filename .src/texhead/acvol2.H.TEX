...
\usepackage{calc}
\usepackage{amsmath,xltxtra,fontspec,xunicode,tocloft,tabu,datetime2,multicol,booktabs}
...
\setsansfont[Numbers=Lining,BoldFont={Inter-Bold},ItalicFont={Inter-Italic},BoldItalicFont={Inter-BoldItalic}]{Inter}
\setmonofont{New Heterodox Mono} % https://github.com/hckiang/font-new-heterodox-mono
...
\renewcommand{\cftchapfont}{\rmfamily\fontspec{Old Standard TT}\rmfamily\small\raggedright}
...
\begin{titlepage}
	...
	\vskip 50pt
    \begingroup
    \fontsize{24pt}{24pt}\selectfont NERUTHES\par
    \vskip 30pt
    \fontsize{18pt}{18pt}\selectfont
    ARTICLES\par COLLECTION\par VOLUME 2\par
    \endgroup
	\vfill
	\small
	\today\par
