...
\newcommand{\doctitle}[2]{
    ...
    \parbox{\textwidth}{%
        ...
        \href{https://neruthes.xyz/#2.pdf}{neruthes.xyz}~~/~~%
        \href{https://neruthes.pages.dev/#2.pdf}{neruthes.pages.dev}~~/~~%
        \href{https://neruthes.vercel.app/#2.pdf}{neruthes.vercel.app}\par
    }\par
    \vskip 20pt
    \hrule
    \vskip 20pt
