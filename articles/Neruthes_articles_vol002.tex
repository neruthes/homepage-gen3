...
\setromanfont[Numbers=Lining]{Calluna}
...
\fancypagestyle{plain}{
    ...
    \chead{}
    \rhead{}
    \lfoot{\small\rmfamily Neruthes Articles Collection~~\S~~Volume 2}
    \cfoot{}
...
\renewcommand{\contentsname}{\LARGE\rmfamily\mdseries Contents}
...
\newcommand{\iarticle}[2]{
    ...
    {\raggedright\LARGE\rmfamily\mdseries#2}\par\vskip 30pt
